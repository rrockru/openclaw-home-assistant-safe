...
export const homeAssistantTools = (tool) => {
    return [
        ...
        tool({
            ...
            description: "List readable Home Assistant entities, enriched with device and area metadata. Filter by domain, device class, and area to minimize returned data.",
            parameters: Type.Object({
                domain: Type.Optional(Type.String({ description: "Exact Home Assistant domain, for example sensor or light." })),
                deviceClass: Type.Optional(Type.String({ description: "Exact device_class, for example temperature, humidity, or battery." })),
